...
from uniad.models.utils.functional import (
...
class MotionHead(BaseMotionHead):
    ...
    def __init__(self,
        ...
        self._load_anchors(
            anchor_info_path,
            dummy_motion_anchors=dummy_motion_anchors,
            dummy_motion_anchor_seed=dummy_motion_anchor_seed,
            dummy_motion_anchor_scale=dummy_motion_anchor_scale,
        )

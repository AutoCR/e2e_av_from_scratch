import torch
from uniad.core.base import AssignResult, BaseAssigner
from uniad.core.bbox import bbox_cxcywh_to_xyxy
...
class SamplingResult_segformer(NiceRepr):
    """
    """
    ...
    def random(cls, rng=None, **kwargs):
        ...
        raise NotImplementedError(
            "SamplingResult_segformer.random is not available in the standalone port."
        )

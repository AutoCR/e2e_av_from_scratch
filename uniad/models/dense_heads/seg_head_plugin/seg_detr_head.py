...
from uniad.core.builder import build_assigner, build_loss, build_sampler
from uniad.core.fp16 import force_fp32
from uniad.core.heads import AnchorFreeHead
from uniad.core.tensor_utils import multi_apply, reduce_mean
from uniad.core.transformer import FFN, build_activation_layer, build_positional_encoding, build_transformer
...
class SegDETRHead(
    ...
    def _init_layers(self):
        ...
        self.reg_ffn = FFN(embed_dims=self.embed_dims,
                           feedforward_channels=self.embed_dims,
                           num_fcs=self.num_reg_fcs,

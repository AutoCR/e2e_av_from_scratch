...
from uniad.core.transformer import TransformerLayerSequence as Transformer
import warnings
import math
import copy
import torch
import torch.nn as nn
from uniad.core.init import xavier_init
from uniad.core.transformer import (BaseTransformerLayer,
...
class SegDeformableTransformer(Transformer):
    ...
    def __init__(self,
        ...
        self.encoder = build_transformer_layer_sequence(kwargs.get("encoder"))
        self.decoder = build_transformer_layer_sequence(kwargs.get("decoder"))

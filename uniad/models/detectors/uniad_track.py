...
from uniad.core.detectors import MVXTwoStageDetector
from uniad.core.fp16 import auto_fp16
from uniad.core.tensor_utils import inverse_sigmoid
from uniad.models.utils.grid_mask import GridMask
import copy
import math
from uniad.core.bbox.util import normalize_bbox
...
class UniADTrack(MVXTwoStageDetector):
    ...
    def __init__(
        ...
        bbox_coder = dict(bbox_coder)
        bbox_coder.pop("type", None)
        self.bbox_coder = DETRTrack3DCoder(**bbox_coder)
        ...
        self.criterion = ClipMatcher(**loss_cfg)

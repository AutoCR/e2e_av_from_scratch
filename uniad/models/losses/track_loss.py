...
from uniad.models.dense_heads.track_head_plugin import Instances
from uniad.core.builder import build_assigner, build_loss
from uniad.core.tensor_utils import reduce_mean
from uniad.core.bbox.util import denormalize_bbox


def iou_3d(bboxes1, bboxes2, *args, **kwargs):

"""Optimizer, LR scheduler, and grad clipping for the NAVSIM BEVFusion runner."""
...
def build_optimizer(model, lr, weight_decay, backbone_lr_mult=1.0):
    # BEVFusion raw recipe uses a single uniform LR (AdamW). backbone_lr_mult kept for API parity but defaults to 1.0 (no split).

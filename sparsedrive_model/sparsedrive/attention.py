...
from .nn_utils import build_dropout
...
class FlashAttention(nn.Module):
    ...
    def forward(self, q, kv, 
        ...
        if flash_attn_unpadded_kvpacked_func is None or not q.is_cuda:
            k, v = kv.unbind(dim=2)
...
class MultiheadFlashAttention(nn.Module):
    ...
    Args:
        ...
        init_cfg: Kept for checkpoint-era constructor compatibility.
            Default: None.
    ...
    def __init__(self,
        ...
        if 'dropout' in kwargs:
            ...
            dropout_layer = dict(type="Dropout", drop_prob=kwargs.pop("dropout"))
